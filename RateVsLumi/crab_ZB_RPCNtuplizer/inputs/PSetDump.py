...
process.totemDAQMappingESSourceXML_TimingDiamond = cms.ESSource("TotemDAQMappingESSourceXML",
    configuration = cms.VPSet(
        ...
        cms.PSet(
            ...
            maskFileNames = cms.vstring(),
            validityRange = cms.EventRange(340000, 0, 1, 362919, 0, 0)
        ),
        cms.PSet(
            mappingFileNames = cms.vstring('CondFormats/PPSObjects/xml/mapping_timing_diamond_2023.xml'),
            maskFileNames = cms.vstring(),
            validityRange = cms.EventRange(362920, 0, 1, 999999999, 0, 0)
        )
    ),
...
process.totemDAQMappingESSourceXML_TotemT2 = cms.ESSource("TotemDAQMappingESSourceXML",
    configuration = cms.VPSet(cms.PSet(
        mappingFileNames = cms.vstring('CondFormats/PPSObjects/xml/mapping_totem_nt2_2021.xml'),
        maskFileNames = cms.vstring(),
        validityRange = cms.EventRange(1, 0, 1, 999999999, 0, 0)
    )),
    sampicSubDetId = cms.uint32(6),
    subSystem = cms.untracked.string('TotemT2'),
    verbosity = cms.untracked.uint32(0)
)
