...
usage       = 'python3 submit_plots.py -f <fill_number>'
...
if fill==8754:
    ...
    out_dir      = "/eos/user/l/lfavilla/RPC/plots/background_Run3toHL/Fill_F8754"
elif fill==9573:
    # RPC_fit_file = "/eos/user/l/lfavilla/RPC/post_RPC_Analyzer/Fill_9573_noblacklist_REp43_sector4/RPC_fit_F9573.root"
    # out_dir      = "/eos/user/l/lfavilla/RPC/plots/background_Run3toHL/RPC_fit_F9573_noblacklist_REp43_sector4"
    # RPC_fit_file = "/eos/user/l/lfavilla/RPC/post_RPC_Analyzer/Fill_9573_singleJob/RPC_fit_F9573.root"
    # out_dir      = "/eos/user/l/lfavilla/RPC/plots/background_Run3toHL/Fill_9573_singleJob"
    ...
    out_dir      = "/eos/user/l/lfavilla/RPC/plots/background_Run3toHL/Fill_9573_dead_and_noisy_noSectorRollSubdvision"
elif fill==10084:
    # RPC_fit_file = "/eos/user/l/lfavilla/RPC/post_RPC_Analyzer/Fill_10084_Dead_and_Noisy/RPC_fit_F10084.root"
    # out_dir      = "/eos/user/l/lfavilla/RPC/plots/background_Run3toHL/Fill_10084_Dead_and_Noisy"
    # web_dir      = "/eos/user/l/lfavilla/www/RPC/plots/background_Run3toHL/Fill_10084_Dead_and_Noisy"

    RPC_fit_file = "/eos/user/l/lfavilla/RPC/post_RPC_Analyzer/Fill_10084_Dead_and_StaticNoisy/RPC_fit_F10084.root"
    out_dir      = "/eos/user/l/lfavilla/RPC/plots/background_Run3toHL/Fill_10084_Dead_and_StaticNoisy"
    web_dir      = "/eos/user/l/lfavilla/www/RPC/plots/background_Run3toHL/Fill_10084_Dead_and_StaticNoisy"
...
for station in barrel_stations:
    print(f"python3 HitRate_eta.py -i {RPC_fit_file} -f {fill} -c {station} -d {out_dir} -wd {web_dir} -p")
    os.system(f"python3 HitRate_eta.py -i {RPC_fit_file} -f {fill} -c {station} -d {out_dir} -wd {web_dir} -p")
    print("\n")
for disk in endcap_disks:
    print(f"python3 HitRate_eta.py -i {RPC_fit_file} -f {fill} -c {disk} -d {out_dir} -wd {web_dir} -p")
    os.system(f"python3 HitRate_eta.py -i {RPC_fit_file} -f {fill} -c {disk} -d {out_dir} -wd {web_dir} -p")
    print("\n")
