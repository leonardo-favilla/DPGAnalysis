...
config.General.requestName              = 'ZB_RPCNtuplizer_F10084_Dead_and_Noisy' # 'ZB_RPCNtuplizer_F<fill_number>
...
config.JobType.inputFiles               = ['./noisy_files/Fill_10084/All_Dead_and_Noisy_strips_ID.txt']
...
config.Data.inputDataset                = '/ZeroBias/Run2024G-PromptReco-v1/AOD' # Fill=10084
...
config.Data.outputDatasetTag            = 'ZB_RPCNtuplizer_F10084_Dead_and_Noisy' # 'ZB_RPCNtuplizer_F<fill_number>
...
config.Data.lumiMask                    = '../golden/Fill_10084/golden_Fill10084.json' # 'https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions24/Cert_Collisions2024_378981_385863_Golden.json' # Fill=10084
