...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2024C/ZeroBias/AOD/PromptReco-v1/000/380/115/00000/132c0550-308e-43c3-b099-3d34a6c33b5c.root')
)
...
process.demo = cms.EDAnalyzer("RPCNtuplizer",
    noisy = cms.string('All_Dead_and_Noisy_strips_ID.txt'),
